...
label {
  ...
  --switchOnA: linear-gradient(90deg, #ecc0, #ecc 0.05em 0.45em, #ecc0) 50% 50% /
      0.5em 4em no-repeat,
    linear-gradient(90deg, #0000, #0002 0.25em 0.75em, #0000) 50% 50% / 1em 4em
        no-repeat,
      linear-gradient(#0000, #0003 0.25em 4.25em, #0000) 50% 50% / 0.5em 4.5em
          no-repeat,
        radial-gradient(12em 6em at 0 0, #95001100 25%, #95001100 50%),
          radial-gradient(12em 6em at 100% 0, #95001100 25%, #95001100 50%),
            radial-gradient(100% 75% at center, #ff002c, #ff002c00 50%) 0 0 /
                0.6em 0.6em,
  ...
  --switchOnB: linear-gradient(90deg, #ecc0, #ecc 0.05em 0.45em, #ecc0) 50% 50% /
      0.5em 4em no-repeat,
    linear-gradient(90deg, #0000, #0002 0.25em 0.75em, #0000) 50% 50% / 1em 4em
        no-repeat,
      linear-gradient(#0000, #0003 0.25em 4.25em, #0000) 50% 50% / 0.5em 4.5em
  ...
  --switchOffA: radial-gradient(
    ...
    radial-gradient(5em 5em at center, #0000 1em, #0002 1.5em 2em, #0000 2.5em),
      radial-gradient(100% 75% at center, #ff002c 25%, #ff002c00 50%) 0 0 /
          0.6em 0.6em,
...
input[type="checkbox"]:after {
  ...
  transition: box-shadow
    var(--transDur) ease-in-out,
      filter
        var(--transDur) ease-in-out, -webkit-filter var(--transDur) ease-in-out;
  width: 100%;
  height: 50%;
}
input[type="checkbox"]:before {
  ...
  box-shadow: 0 0.2em 0 0 #fff0 inset, -0.5em -0.5em 0.5em #0000,
...
input[type="checkbox"]:after {
  ...
  box-shadow: 0 -0.2em 0 0 #fff0 inset, -0.5em 0 0.5em #0007,
    0.5em 0 0.5em #0007;
  top: 50%;
  transform: rotateX(20deg);
...
input[type="checkbox"]:checked:before {
  ...
  box-shadow: 0 0.2em 0 0 #fff inset, -0.5em -0.5em 0.5em #0007,
    0.5em -0.5em 0.5em #0007;
}
input[type="checkbox"]:checked:after {
  animation: switchAfterOn var(--transDur) steps(1, start) forwards;
  box-shadow: 0 -0.2em 0 0 #fff7 inset, -0.5em 0 0.5em #0000,
    0.5em 0 0.5em #0000;
}
