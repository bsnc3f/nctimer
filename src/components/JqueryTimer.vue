<template>
  <div id="app" class="countdown"></div>
  <!-- <div id="app" class="countdown"></div> -->
</template>
...
.countdown {
  ...
  border-top: 10px solid rgb(30, 33, 233);
  border-bottom: 10px solid rgb(30, 33, 233);
  /* border-bottom: 10px solid #E54B6B; */
